...
from PyQt5.QtWidgets import QMainWindow, QApplication, QMessageBox, QVBoxLayout, QWidget, QShortcut,QPushButton, QTextEdit, QLineEdit, QFormLayout, QHBoxLayout, QCheckBox, QSpinBox, QDoubleSpinBox
...
class App(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle("Generate LaTeX")
    ...
    def returnSnip(self, img=None):
        ...
        try:
            ...
            pass
        # Running the model in a separate thread
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--checkpoint', type=str, default='checkpoints/mixed/mixed_e01.pth', help='path to weights file')
