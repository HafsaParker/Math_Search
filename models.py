...
def get_model(args, training=False):#28-29
    ...
    def embed_layer(**x):
        ...
        return HybridEmbed(**x, patch_size=ps//min_patch_size, backbone=backbone)#29
